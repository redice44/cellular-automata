...
var conway_1 = __webpack_require__(50);
function init() {
    var canvasWidth = 600;
    var canvasHeight = 600;
    var tickSpeed = 100; //Math.floor(1000/60);
    var envWidth = 60;
    var envHeight = 60;
    var spawnRate = 0.3;
...
Object.defineProperty(exports, "__esModule", { value: true });
var d3Selection = __webpack_require__(16);
var d3Timer = __webpack_require__(52);
var Canvas = /** @class */ (function () {
    function Canvas(environment, rootNode, width, height, tickSpeed) {
    ...
    Canvas.prototype.update = function () {
        var _this = this;
        this.timer = d3Timer.interval(function () {
            _this.dataBind();
            _this.draw();
        }, this.tickSpeed);
    };
    Canvas.prototype.dataBind = function () {
        var _this = this;
        var cells = this.dataContainer.selectAll('.cell').data(this.environment.tick());
        cells.exit().remove();
        cells.enter().append('custom')
            .classed('cell', true)
            .attr('width', this.cellWidth)
            .attr('height', this.cellHeight)
            .attr('x', function (d, i) { return _this.environment.getX(i) * _this.cellWidth; })
            .attr('y', function (d, i) { return _this.environment.getY(i) * _this.cellHeight; })
    ...
    Canvas.prototype.draw = function () {
        ...
        context.fill();
        var elements = this.dataContainer.selectAll('custom.cell');
    ...
    Canvas.prototype.bindHandlers = function () {
        ...
        this.canvas.on('click', function () {
            ...
            _this.environment.makeToggle(_this.environment.getIndex(mouseX - 1, mouseY - 1));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_select__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_selectAll__ = __webpack_require__(47);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__src_selectorAll__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_touch__ = __webpack_require__(48);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_touches__ = __webpack_require__(49);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sourceEvent__ = __webpack_require__(4);
...
(function (STATE) {
    ...
    STATE[STATE["CLICKA"] = 2] = "CLICKA";
    STATE[STATE["CLICKD"] = 3] = "CLICKD";
})(STATE || (STATE = {}));
var Conway = /** @class */ (function () {
    function Conway(width, height, rate) {
    ...
    Conway.prototype.setColor = function (state) {
        switch (state) {
            case STATE.ALIVE:
                return "rgb(0, 0, 0)";
            case STATE.DEAD:
    ...
    Conway.prototype.cellUpdate = function (state, index) {
        ...
        var aliveNeighbors = this.sumOfNeighbors(index);
        switch (state) {
            case STATE.ALIVE:
            case STATE.CLICKA:
    ...
    Conway.prototype.sumOfNeighbors = function (index) {
    ...
    Conway.prototype.getBottom = function (i) {
        var y = this.getY(i);
        return y === this.height - 1 ? 0 : y + 1;
    };
    Conway.prototype.getLeft = function (i) {
        var x = this.getX(i);
    ...
    Conway.prototype.getUpNeighbor = function (i) {
        return this.getIndex(this.getX(i), this.getTop(i));
    };
    Conway.prototype.getUpRightNeighbor = function (i) {
        return this.getIndex(this.getRight(i), this.getTop(i));
    };
    Conway.prototype.getLeftNeighbor = function (i) {
        return this.getIndex(this.getLeft(i), this.getY(i));
    };
    Conway.prototype.getRightNeightbor = function (i) {
        return this.getIndex(this.getRight(i), this.getY(i));
    };
    Conway.prototype.getBottomLeftNeighbor = function (i) {
        return this.getIndex(this.getLeft(i), this.getBottom(i));
    };
    Conway.prototype.getBottomNeighbor = function (i) {
        return this.getIndex(this.getX(i), this.getBottom(i));
    };
    Conway.prototype.getBottomRightNeighbor = function (i) {
        return this.getIndex(this.getRight(i), this.getBottom(i));
    };
    Conway.prototype.initEnvironment = function (size, rate) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_timer__ = __webpack_require__(51);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_timeout__ = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_interval__ = __webpack_require__(54);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__timer__ = __webpack_require__(51);
